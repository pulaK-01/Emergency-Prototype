  ...
  Future<void> _getExactLocation() async {
    ...
    try {
      ...
      setState(() {
        ...
        _isLoading = false;
        _statusMessage = '✅ Location: ${position.latitude.toStringAsFixed(6)}, ${position.longitude.toStringAsFixed(6)}\nHelp is on the way!';
      });
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _errorMessage != null ? Colors.red[50] : Colors.grey[100],
